...
// import ColorModal from "./ColorModal"; // Temporarily remove this import if not needed
...
const Navbar = () => {
    ...
    // Commenting out color-related code
    ...
    // Commenting out color selector functions
        ...
        <div className="main">
            <div className="navbar" style={{ backgroundColor: bgColor }}>
                ...
                <div className="selectTheme">
                    ...
                    {/* Commented out color selector UI */}
